package com.ht.demoandroidnetwork.activity;
...
import com.ht.demoandroidnetwork.adapter.WeatherAdapter;
...
public class MainActivity extends AppCompatActivity {
    ...
    WeatherAdapter weatherAdapter = new WeatherAdapter(this, R.layout.layout_weather_items, weatherForecastModelList);
    @Override
...
//weatherAdapter.notifyDataSetChanged();
    ...
    private void GetData(String cityName) {
        String url
                ="https://api.weatherapi.com/v1/forecast.json?key=fc8f4188ad3f48d8a10132707221212&q="+cityName+"&days=1&aqi=no&alerts=no";
